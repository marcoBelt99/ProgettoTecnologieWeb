...
class FundraisersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $fundraiser7 = Fundraiser::create([
            ...
            'description' => 'Fabio ci ha lasciati a soli 35 anni dopo la sua dura battaglia contro la malattia.
            Lascia la sua amata Lucia e le sue adorate bambine Giulia e Marta. 
